      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-navy">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16 md:mb-20 animate-fade-in">
            <h1 className="font-serif text-7xl md:text-9xl lg:text-[12rem] font-bold tracking-tight mb-6 md:mb-8 leading-none">
              3N
            </h1>
            <div className="h-px w-24 sm:w-32 md:w-40 bg-accent-gold mx-auto mb-6 md:mb-8"></div>
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl tracking-[0.2em] sm:tracking-[0.3em] uppercase font-light">
              The Art of Sleep
            </p>
          </div>
          <p className="text-base md:text-lg lg:text-xl max-w-2xl lg:max-w-3xl mx-auto leading-relaxed mb-12 md:mb-16 font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
            <Link href="/collection">
              <Button 
                size="lg" 
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-navy transition-all duration-300 px-8 sm:px-12 py-3 sm:py-4 min-w-[200px] sm:min-w-[220px]"
              >
                Discover Collection
              </Button>
            </Link>
            <Link href="/contact">
              <Button 
                size="lg" 
                className="bg-accent-gold border-2 border-accent-gold text-navy hover:bg-transparent hover:text-white transition-all duration-300 px-8 sm:px-12 py-3 sm:py-4 min-w-[200px] sm:min-w-[220px]"
              >
                Get in Touch
              </Button>
            </Link>
      ...
      <section className="py-20 sm:py-24 lg:py-32 bg-ivory">
        <div className="mx-auto max-w-full px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-navy mb-4 sm:mb-6 tracking-tight">
              Essential Companions
            </h2>
            <div className="h-px w-24 sm:w-32 bg-accent-gold mx-auto mb-6 sm:mb-8"></div>
            <p className="text-gray-600 text-base sm:text-lg md:text-xl mx-auto leading-relaxed px-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 xl:gap-24 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6 sm:space-y-8 text-center lg:text-left">
              <div>
                <p className="text-accent-gold text-sm sm:text-base uppercase tracking-widest mb-3 sm:mb-4">Our Story</p>
                <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl text-navy mb-4 sm:mb-6 leading-tight">
                  Where Luxury Meets Comfort
                </h2>
                <div className="h-px w-20 sm:w-24 bg-accent-gold mb-6 sm:mb-8 mx-auto lg:mx-0"></div>
              </div>
              <div className="space-y-4 sm:space-y-6 text-gray-700 leading-relaxed text-base sm:text-lg max-w-xl mx-auto lg:mx-0">
                <p>
